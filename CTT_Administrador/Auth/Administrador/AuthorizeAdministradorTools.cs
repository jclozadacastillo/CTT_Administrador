...
{
    public class AuthorizeAdministradorTools : IAuthorizeAdministradorTools
    {
        private IHttpContextAccessor _context;
        private string _token;
        private string _cookieName = ConfigurationHelper.config["JWT:cookieNames:admin"];

        public AuthorizeAdministradorTools(IHttpContextAccessor context)
        {
            _context = context;
