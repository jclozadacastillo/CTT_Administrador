...
{
    public class AuthorizeAsesorTools : IAuthorizeAsesorTools
    {
        private IHttpContextAccessor _context;
        private string _token;
        private string _cookieName = ConfigurationHelper.config["JWT:cookieNames:asesor"];

        public AuthorizeAsesorTools(IHttpContextAccessor context)
        {
            _context = context;
