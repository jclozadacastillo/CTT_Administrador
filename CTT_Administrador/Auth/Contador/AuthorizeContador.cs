...
namespace CTT_Administrador.Auth.Contador
{
    ...
    public class AuthorizeContador : Attribute, IAuthorizationFilter
    {
        public string? Roles { get; set; }
        private AuthorizationFilterContext? _context;
        public static readonly string _cookieName = ConfigurationHelper.config["JWT:cookieNames:contador"];
