...
{
    public class AuthorizeContadorTools : IAuthorizeContadorTools
    {
        private IHttpContextAccessor _context;
        private string _token;
        private string _cookieName = ConfigurationHelper.config["JWT:cookieNames:contador"];

        public AuthorizeContadorTools(IHttpContextAccessor context)
        {
            _context = context;
